...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'whwn_user', 'full_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=71, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.full_name'
        db.delete_column(u'whwn_user', 'full_name')
    ...
    models = {
        ...
        u'whwn.user': {
            ...
            'full_name': ('django.db.models.fields.CharField', [], {'max_length': '71', 'blank': 'True'}),
